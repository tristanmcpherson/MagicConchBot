...
namespace MagicConchBot.Handlers
{
    public class CmdSrv : CommandService
    {
        ...
        public new async Task<IResult> ExecuteAsync(ICommandContext context, string input, IDependencyMap dependencyMap = null, MultiMatchHandling multiMatchHandling = MultiMatchHandling.Exception)
        {
